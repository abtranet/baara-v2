      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="text-2xl font-extrabold text-white hover:text-amber-400 transition-colors">
              Baara
            </Link>
            <p className="mt-3 text-sm text-stone-400 leading-relaxed">
              AI automation and digital skills for African entrepreneurs, professionals, and communities.
              <br />
              <em className="text-stone-500">Baara</em> means &ldquo;work&rdquo; in Bambara.
            </p>
        ...
        <div className="border-t border-stone-800 pt-8 space-y-3">
          <p className="text-xs text-stone-500 leading-relaxed">
            <strong className="text-stone-400">Baara Academy</strong> is vendor-neutral and does not provide
          ...
          <p className="text-xs text-stone-600">
            © {year} Baara · A GlobalSABT initiative · Built by Abdel Traore ·{" "}
            <span className="text-stone-500">Jacksonville, Florida</span>
          </p>
        </div>
      </div>
    </footer>
