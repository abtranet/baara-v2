        ...
        <Container>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {demoVideos.map((video) => (
              <div
                key={video.id}
                className="bg-indigo-50 border border-blue-100 rounded-2xl overflow-hidden flex flex-col"
              >
                <div className="bg-blue-700 aspect-video flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="w-12 h-12 border-2 border-blue-300 rounded-full flex items-center justify-center mx-auto mb-2 opacity-70">
                      <span className="text-xl">&#9654;</span>
                    </div>
                    <span className="text-xs text-blue-300 uppercase tracking-widest">Coming Soon</span>
                  </div>
                </div>
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <span className="text-xs text-slate-400 mt-3">{video.duration}</span>
                </div>
              </div>
            ))}
          </div>
